...
export type ImageFragment = { __typename?: "Image"; uri: string } & {
  " $fragmentName"?: "ImageFragment";
};

export type CategoryFragment = { __typename?: "Category"; name: string } & {
...
export const ExpertFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
...
} as unknown as DocumentNode<ExpertFragment, unknown>;
